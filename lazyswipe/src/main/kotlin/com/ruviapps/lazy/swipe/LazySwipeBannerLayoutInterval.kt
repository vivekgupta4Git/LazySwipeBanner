 ...
 * [LazySwipeBannerLayoutIntervalContent.Interval], and is used to associate:
 *
 ...
 * @see LazySwipeBannerLayoutComposable
 */
class LazySwipeBannerLayoutInterval(
    override val key: ((Int) -> Any)?,
    override val type: ((index: Int) -> Any?),
    val item: LazySwipeBannerLayoutComposable
) : LazySwipeBannerLayoutIntervalContent.Interval